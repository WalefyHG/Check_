...
class ClearingModal extends StatelessWidget{
  final TodoModel todo;

  const ClearingModal({super.key, required this.todo});
                ...
                child: DecoratedBox(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text('Deseja realmente excluir todas as tarefas?', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white),),
